...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header" style="background-color: #bfecd5">{{ __('Register') }}</div>

                <div class="card-body" style="background-color: #c5c9ca">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn" style="background-color: #0cc170">
                                    {{ __('Register') }}
                                </button>
                            </div>
                        </div>
